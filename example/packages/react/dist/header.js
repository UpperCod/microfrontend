...
var r$1 = {
  ...
  return function (r, e, t) {
    ...
    for (var e, t = [{}]; e = a.exec(r.replace(n$1, ""));) e[4] && t.shift(), e[3] ? t.unshift(t[0][e[3]] = {}) : e[4] || (t[0][e[1]] = e[2]);
...
function s(r) {
  var t = this || {},
      a = r.call ? r(t.p) : r;
  return o(a.map ? u$1(a, [].slice.call(arguments, 1), t.p) : a, e(t.target), t.g, t.o);
}
...
p$1(react.createElement);
const Title = g("h1")`
  font-weight: bold;
  color: dodgerblue;
`;
function header () {
  return react.createElement("header", null, react.createElement("strong", null, "Logo"), react.createElement("nav", null, react.createElement("a", null, "1"), react.createElement("a", null, "2"), react.createElement("a", null, "3"), react.createElement(Title, null, "...s")));
}
